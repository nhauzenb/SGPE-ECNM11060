...
top10_analytical=exp(lt1)/sum(exp(lt1));
top10_analytical

'Prob of top 10 models, numerical (after deleting rest of models)'
top10_numerical=top10count./sum(top10count);
top10_numerical

'Prob of top 10 models out of total number of models, numerical'
ptop10=sum(top10count)/nkeep;
ptop10



'Prob of top 10 models (analytical then numerical) without deleting rest of models'
ptop10a= ptop10*top10_analytical;
ptop10n= ptop10*top10_numerical;
[ptop10a, ptop10n]
 b1mo=b1mo./nkeep;
 b2mo=b2mo./nkeep;
 bsd=sqrt(b2mo-b1mo.^2);
 'BMA Posterior mean and stand dev of each coefficient'
 [varcount b1mo bsd]
 
'Best model Posterior mean and stand dev of each coefficient'
[varcount b_best, sqrt(bvar_best)]
